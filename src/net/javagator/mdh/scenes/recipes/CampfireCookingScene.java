...
public class CampfireCookingScene extends SceneRetriever {

	@Override
	public void buildScene() {
		sceneTitle = "Mod Development Helper | Campfire Cooking Recipe Generator";
		
		Text header = new Text();
		header.setFont(Main.headerFont);
		header.setText("Campfire Cooking Recipes");
		...
		finish.setOnAction(e -> {
			...
			jsonRoot.addProperty("type", "minecraft:campfire_cooking");
