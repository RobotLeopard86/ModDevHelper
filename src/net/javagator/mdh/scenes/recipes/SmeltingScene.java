...
public class SmeltingScene extends SceneRetriever {

	@Override
	public void buildScene() {
		sceneTitle = "Mod Development Helper | Furnace Recipe Generator";
		
		Text header = new Text();
		header.setFont(Main.headerFont);
		header.setText("Smelting Recipes");
		...
		finish.setOnAction(e -> {
			...
			jsonRoot.addProperty("type", "minecraft:smelting");
