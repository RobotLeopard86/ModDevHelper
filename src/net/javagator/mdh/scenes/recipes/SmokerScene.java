...
public class SmokerScene extends SceneRetriever {

	@Override
	public void buildScene() {
		sceneTitle = "Mod Development Helper | Smoker Recipe Generator";
		
		Text header = new Text();
		header.setFont(Main.headerFont);
		header.setText("Smoking Recipes");
		...
		finish.setOnAction(e -> {
			...
			jsonRoot.addProperty("type", "minecraft:smoking");
